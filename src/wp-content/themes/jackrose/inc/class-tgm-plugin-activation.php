 ...
 *
 * Modified:
 * - Change no_items() text.
 * - Keep TGMPA menu even if there is no required plugins need to be installed.
 */
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		public function no_items() {
			echo esc_html__( 'All required plugins are already installed and activated.', 'tgmpa' ) . ' <a href="' . esc_url( add_query_arg( array( 'page' => get_template() . '-dashboard', 'tab' => 'getting-started' ), admin_url( 'admin.php' ) ) ) . '"> ' . esc_html__( 'Return to the Theme Dashboard', 'tgmpa' ) . '</a>';
