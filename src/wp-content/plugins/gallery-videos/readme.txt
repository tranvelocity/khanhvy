...
* You may create unlimited Galleries by this plugin through our options.

= 8). How to include the Gallery Post or Page? =

* Every Gallery has its own ID number. Simply you must copy it and paste to that place where you want to see.
